...
namespace Pinturas.DataAccess.Data
{
    public class PinturasDbContext : DbContext
    {

        public PinturasDbContext(DbContextOptions<PinturasDbContext> options):base(options)
        {
